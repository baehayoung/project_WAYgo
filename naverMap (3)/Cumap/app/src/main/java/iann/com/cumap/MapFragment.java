...
public class MapFragment extends Fragment {
    ...
    private static final String CLIENT_ID = "3T8Bg6DqGOP83kjuLUYi";// Application client ID value
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Fragment placefragment=(Fragment) getFragmentManager().findFragmentById(R.id.placefragment);
    ...
    private void testPathPOIdataOverlay() {
        ...
        poiData.addPOIitem(349652983, 149297368, " 124-456", NMapPOIflagType.FROM, null);
        ...
        poiData.addPOIitem(349651376, 149297750, " 000-999", NMapPOIflagType.TO, null);
        poiData.endPOIdata();
    ...
    private void testPOIdataOverlay() {
        ...
        NMapPOIitem item = poiData.addPOIitem(127.0630205, 37.5091300, " 777-111", markerId, 0);
        item.setRightAccessory(true, NMapPOIflagType.CLICKABLE_ARROW);
        poiData.addPOIitem(127.061, 37.51, " 123-456", markerId, 0);
        poiData.addPOIitem(127.062, 37.52, " 123-416", markerId, 0);
        poiData.endPOIdata();
    ...
    private void testFloatingPOIdataOverlay() {
       ...
       // int marker2 = NMapPOIflagType.PIN;
     ...
     //   poiData.addPOIitem(null, "Touch & Drag to Move", marker2, 0);
        poiData.endPOIdata();
    ...
    private final NMapLocationManager.OnLocationChangeListener onMyLocationChangeListener = new NMapLocationManager.OnLocationChangeListener() {
        ...
        public boolean onLocationChanged(NMapLocationManager locationManager, NGeoPoint myLocation) {
            ...
            Toast.makeText(getContext().getApplicationContext(), "현재위도: " +myLocation.getLatitude()+"경도: "+myLocation.getLongitude(), Toast.LENGTH_LONG).show();
            return true;
        }
    ...
    private final NMapPOIdataOverlay.OnFloatingItemChangeListener onPOIdataFloatingItemChangeListener = new NMapPOIdataOverlay.OnFloatingItemChangeListener() {
        ...
        public void onPointChanged(NMapPOIdataOverlay poiDataOverlay, NMapPOIitem item) {
            ...
            Toast.makeText(getContext().getApplicationContext(), "위도: " + point.latitude+"경도: "+point.longitude, Toast.LENGTH_LONG).show();
            item.setTitle(null);
